<?php
/**
 * Suma la acción de obtener un producto mediante ajax
 */
...
function apd_add_quick_view_button() {
	...
	?>
	<input type="button" class="apd-quick-view" value="<?php _e( 'Vista rápida', 'ajax-product-details' ); ?>" product-id="<?php echo $product->get_ID(); ?>" />
	<?php
	}
}
